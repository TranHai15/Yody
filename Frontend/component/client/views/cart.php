                ...
                <div class="cart__product--items">
                    ...
                    <?php else: ?>
                        <div class="themgioHang">
                            <h6 style="text-align: center; font-size:31px; font-weight: 600; color: #1c2430;  ">Giỏ hàng
                            </h6>
                            <p style="font-size: 14px; margin-top: 15px; color:#4b6281; text-align:center;">Không có sản
                                phẩm nào trong giỏ
                                hàng</p>
                            <img src="Frontend/public/img/cart-empty.250eba9c.svg" alt="">
